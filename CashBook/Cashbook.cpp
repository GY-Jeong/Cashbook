...
void Cashbook::searchDetail(string start_date, string end_date, string category_name, vector<vector<string>> category_list, bool is_pay)
{
	CLEAR;
	cout << category_name << "의 상세 내역입니다." << endl;
